...
### Uninstall:
To remove the Add-in either:
- Uninstall it from *Add/Remove Programs* in *Windows Settings*,
- Or in *Microsoft Word*, go to `File > Options > Add-ins`, click `Go` next to *Manage COM Add-ins*, click on `AdaptationsTools`, and click `Remove`.
